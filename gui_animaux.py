...
pygame.display.flip()
img_enclos = pygame.image.load("dessins/enclos.png").convert_alpha()
#img_crayon = pygame.image.load("dessins/crayon.png").convert_alpha()
#img_crayon = pygame.transform.scale(img_crayon,(25,25))
img_poule = pygame.image.load("dessins/poule.png").convert_alpha()
img_poule2 = pygame.image.load("dessins/poule_oeuf.png").convert_alpha()
img_vache = pygame.image.load("dessins/vache.png").convert_alpha()
img_vache2 = pygame.image.load("dessins/vache_lait.png").convert_alpha()
img_mouton = pygame.image.load("dessins/mouton.png").convert_alpha()
img_mouton2 = pygame.image.load("dessins/mouton_laine.png").convert_alpha() 
img_ruche = pygame.image.load("dessins/ruche.png").convert_alpha()
img_ruche2 = pygame.image.load("dessins/ruche_miel.png").convert_alpha() 
